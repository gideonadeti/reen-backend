...
export class EventsHandlerController {
  ...
  @EventPattern('apply-financial-effects')
  handleApplyFinancialEffects(@Payload() data: SagaFlowProps) {
    return this.eventsHandlerService.handleApplyFinancialEffects(data);
  }
